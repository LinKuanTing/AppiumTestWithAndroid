...
public class TestCaseFailRegisterByCharacterAct extends WDFnL1Register{
    ...
    private static String __strFileName = "TestDataFailRegisterByCharacterAct";
    private static String __strFilePath;

    public void execute() throws IOException, InterruptedException {
        Logger logger = LoggerFactory.getLogger(TestCaseFailRegisterByCharacterAct.class);

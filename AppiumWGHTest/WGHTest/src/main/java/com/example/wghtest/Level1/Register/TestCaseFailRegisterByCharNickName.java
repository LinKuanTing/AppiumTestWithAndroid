...
public class TestCaseFailRegisterByCharNickName extends WDFnL1Register {
    ...
    private static String __strFileName = "TestDataFailRegisterByCharNickName";
    private static String __strFilePath;

    public void execute() throws InterruptedException, IOException {
        Logger logger = LoggerFactory.getLogger(TestCaseFailRegisterByCharNickName.class);
        ...
        if (adDriver.findElement(By.id(_strRegisterMsg3ID)).getText().equals(__strCHRegisterMsg)){
            ...
            logger.debug("Reason: Register message is different from expect content.");
